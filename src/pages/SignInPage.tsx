    ...
    <div className="min-h-[calc(100vh-120px)] flex items-center justify-center p-4 bg-[#F8FAFC]">
      <div className="relative w-full max-w-md bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xl overflow-hidden">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-xl font-black text-slate-900 font-['Inter',sans-serif]">Sign In</h2>
            <p className="text-xs text-slate-500 font-medium">Welcome back! Access your account.</p>
          </div>
        </div>
        ...
        <div className="mt-6 pt-4 border-t border-slate-100 text-center text-xs text-slate-500">
          ...
          <Link to="/signup" className="font-bold text-[#1E65FF] hover:underline">
            Sign Up
          </Link>
        </div>
      </div>
